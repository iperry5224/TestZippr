# SOPRA Assessment Script: SCR-006 - Supply Chain Incident Notification
# Category: Supply Chain Risk Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SCR_006.ps1
...
$category = "Supply Chain Risk Management"
$control_id = "SCR-006"
$control_name = "Supply Chain Incident Notification"
