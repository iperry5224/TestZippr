# SOPRA Assessment Script: SRV-006 - Email Server Security
# Category: Server Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SRV_006.ps1
...
$category = "Server Security"
$control_id = "SRV-006"
$control_name = "Email Server Security"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Set-ReceiveConnector -Identity ''Internet'' -RequireTLS $true'
