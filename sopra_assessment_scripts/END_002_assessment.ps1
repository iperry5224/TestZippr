# SOPRA Assessment Script: END-002 - Patch Management
# Category: Endpoint Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: END_002.ps1
...
try {
    $out = Invoke-Expression 'Get-WindowsUpdate -ComputerName <hostname> | Where-Object {$_.IsInstalled -eq $false}'
