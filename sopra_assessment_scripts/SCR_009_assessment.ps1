# SOPRA Assessment Script: SCR-009 - End-of-Life Technology Management
# Category: Supply Chain Risk Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SCR_009.ps1
...
$category = "Supply Chain Risk Management"
$control_id = "SCR-009"
$control_name = "End-of-Life Technology Management"
