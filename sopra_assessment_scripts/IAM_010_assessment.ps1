# SOPRA Assessment Script: IAM-010 - Identity Federation
# Category: Identity & Access Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: IAM_010.ps1
...
$category = "Identity & Access Management"
$control_id = "IAM-010"
$control_name = "Identity Federation"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-ADFSRelyingPartyTrust | Select-Object Name, Enabled, TokenLifetime'
