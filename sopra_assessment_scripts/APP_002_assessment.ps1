# SOPRA Assessment Script: APP-002 - Static Application Security Testing
# Category: Application Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: APP_002.ps1
...
$category = "Application Security"
$control_id = "APP-002"
$control_name = "Static Application Security Testing"
