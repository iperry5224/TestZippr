# SOPRA Assessment Script: END-006 - USB/Removable Media Control
# Category: Endpoint Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: END_006.ps1
...
$category = "Endpoint Security"
$control_id = "END-006"
$control_name = "USB/Removable Media Control"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-ItemProperty ''HKLM:\SYSTEM\CurrentControlSet\Services\USBSTOR'' -Name Start'
