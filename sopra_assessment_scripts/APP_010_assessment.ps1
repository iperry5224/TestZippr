# SOPRA Assessment Script: APP-010 - Security Headers & TLS Configuration
# Category: Application Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: APP_010.ps1
...
$category = "Application Security"
$control_id = "APP-010"
$control_name = "Security Headers & TLS Configuration"
