# SOPRA Assessment Script: IAM-002 - Privileged Access Management
# Category: Identity & Access Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: IAM_002.ps1
...
try {
    $out = Invoke-Expression 'Get-ADGroupMember ''Domain Admins'' | Select-Object Name, SamAccountName'
