# SOPRA Assessment Script: CFG-008 - Network Device Configuration Backup
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_008.ps1
...
$category = "Configuration Management"
$control_id = "CFG-008"
$control_name = "Network Device Configuration Backup"
