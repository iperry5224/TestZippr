# SOPRA Assessment Script: ECS-009 - Collaboration Platform Security
# Category: Email & Communications Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: ECS_009.ps1
...
$category = "Email & Communications Security"
$control_id = "ECS-009"
$control_name = "Collaboration Platform Security"
