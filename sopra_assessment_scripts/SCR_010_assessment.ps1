# SOPRA Assessment Script: SCR-010 - Open Source Software Governance
# Category: Supply Chain Risk Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SCR_010.ps1
...
$category = "Supply Chain Risk Management"
$control_id = "SCR-010"
$control_name = "Open Source Software Governance"
