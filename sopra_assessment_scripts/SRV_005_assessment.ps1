# SOPRA Assessment Script: SRV-005 - Web Server Security
# Category: Server Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SRV_005.ps1
...
$category = "Server Security"
$control_id = "SRV-005"
$control_name = "Web Server Security"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Remove-WindowsFeature Web-DAV-Publishing'
