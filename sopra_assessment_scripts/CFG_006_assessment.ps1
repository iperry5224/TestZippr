# SOPRA Assessment Script: CFG-006 - Configuration Drift Detection
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_006.ps1
...
$category = "Configuration Management"
$control_id = "CFG-006"
$control_name = "Configuration Drift Detection"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Install-Module -Name PSDscResources -Force'
