# SOPRA Assessment Script: SCR-008 - Cloud Service Provider Assessment
# Category: Supply Chain Risk Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SCR_008.ps1
...
$category = "Supply Chain Risk Management"
$control_id = "SCR-008"
$control_name = "Cloud Service Provider Assessment"
