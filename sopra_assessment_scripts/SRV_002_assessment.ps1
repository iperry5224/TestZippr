# SOPRA Assessment Script: SRV-002 - Unnecessary Services Disabled
# Category: Server Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SRV_002.ps1
...
$category = "Server Security"
$control_id = "SRV-002"
$control_name = "Unnecessary Services Disabled"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-Service | Where-Object {$_.Status -eq ''Running''} | Select-Object Name, DisplayName, StartType'
