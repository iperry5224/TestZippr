# SOPRA Assessment Script: SAT-009 - Security Training Effectiveness Measurement
# Category: Security Awareness & Training
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SAT_009.ps1
...
$category = "Security Awareness & Training"
$control_id = "SAT-009"
$control_name = "Security Training Effectiveness Measurement"
