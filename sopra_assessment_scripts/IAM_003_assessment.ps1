# SOPRA Assessment Script: IAM-003 - Role-Based Access Control
# Category: Identity & Access Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: IAM_003.ps1
...
try {
    $out = Invoke-Expression 'New-ADGroup -Name ''Role_Finance_ReadOnly'' -GroupScope Global -GroupCategory Security'
