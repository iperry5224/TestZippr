# SOPRA Assessment Script: CRY-007 - Deprecated Algorithm Remediation
# Category: Cryptographic Controls
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CRY_007.ps1
...
$category = "Cryptographic Controls"
$control_id = "CRY-007"
$control_name = "Deprecated Algorithm Remediation"
