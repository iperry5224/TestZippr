# SOPRA Assessment Script: CRY-003 - Certificate Lifecycle Management
# Category: Cryptographic Controls
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CRY_003.ps1
...
try {
    $out = Invoke-Expression 'Get-ChildItem -Path Cert:\LocalMachine\My | Select-Object Subject, NotAfter, Issuer | Sort-Object NotAfter'
