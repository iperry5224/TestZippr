# SOPRA Assessment Script: GOV-003 - Security Assessment & Authorization
# Category: Governance & Compliance
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: GOV_003.ps1
...
$category = "Governance & Compliance"
$control_id = "GOV-003"
$control_name = "Security Assessment & Authorization"
