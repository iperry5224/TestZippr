# SOPRA Assessment Script: CP-009 - Essential Personnel Identification
# Category: Contingency Planning
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CP_009.ps1
...
$category = "Contingency Planning"
$control_id = "CP-009"
$control_name = "Essential Personnel Identification"
