# SOPRA Assessment Script: ECS-006 - Unified Communications Security
# Category: Email & Communications Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: ECS_006.ps1
...
$category = "Email & Communications Security"
$control_id = "ECS-006"
$control_name = "Unified Communications Security"
