# SOPRA Assessment Script: CFG-003 - Golden Image Management
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_003.ps1
...
$category = "Configuration Management"
$control_id = "CFG-003"
$control_name = "Golden Image Management"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'New-ScheduledTask -Action (New-ScheduledTaskAction -Execute ''C:\Scripts\Update-GoldenImage.ps1'') -Trigger (New-ScheduledTaskTrigger -Weekly -DaysOfWeek Wednesday -WeeksInterval 4)'
