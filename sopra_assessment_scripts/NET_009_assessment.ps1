# SOPRA Assessment Script: NET-009 - DNS Security
# Category: Network Infrastructure
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: NET_009.ps1
...
$category = "Network Infrastructure"
$control_id = "NET-009"
$control_name = "DNS Security"

# Discovery only - manual review required
try {
    $out = Invoke-Expression '# Windows: dnscmd /config /logLevel 0x8000F301'
