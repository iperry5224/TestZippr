# SOPRA Assessment Script: CFG-004 - Software Inventory Control
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_004.ps1
...
$category = "Configuration Management"
$control_id = "CFG-004"
$control_name = "Software Inventory Control"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-WmiObject Win32_Product | Where-Object {$_.Name -notin (Get-Content ''C:\Config\ApprovedSoftware.txt'')} | Export-Csv ''UnauthorizedSoftware.csv'''
