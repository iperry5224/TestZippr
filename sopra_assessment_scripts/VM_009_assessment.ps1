# SOPRA Assessment Script: VM-009 - Vulnerability Exception Management
# Category: Vulnerability Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: VM_009.ps1
...
$category = "Vulnerability Management"
$control_id = "VM-009"
$control_name = "Vulnerability Exception Management"
