# SOPRA Assessment Script: IR-005 - Incident Classification & Prioritization
# Category: Incident Response
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: IR_005.ps1
...
$category = "Incident Response"
$control_id = "IR-005"
$control_name = "Incident Classification & Prioritization"
