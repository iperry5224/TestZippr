# SOPRA Assessment Script: APP-003 - Dynamic Application Security Testing
# Category: Application Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: APP_003.ps1
...
$category = "Application Security"
$control_id = "APP-003"
$control_name = "Dynamic Application Security Testing"
