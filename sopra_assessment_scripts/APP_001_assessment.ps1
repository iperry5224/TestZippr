# SOPRA Assessment Script: APP-001 - Secure Software Development Lifecycle
# Category: Application Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: APP_001.ps1
...
$category = "Application Security"
$control_id = "APP-001"
$control_name = "Secure Software Development Lifecycle"
