# SOPRA Assessment Script: VM-008 - Database Vulnerability Assessment
# Category: Vulnerability Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: VM_008.ps1
...
$category = "Vulnerability Management"
$control_id = "VM-008"
$control_name = "Database Vulnerability Assessment"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Invoke-SqlVulnerabilityAssessment -ServerInstance ''SQLSERVER01'' -DatabaseName ''ALL'''
