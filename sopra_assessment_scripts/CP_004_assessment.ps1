# SOPRA Assessment Script: CP-004 - Backup Verification & Testing
# Category: Contingency Planning
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CP_004.ps1
...
$category = "Contingency Planning"
$control_id = "CP-004"
$control_name = "Backup Verification & Testing"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Test-DbaLastBackup -SqlInstance ''SQLSERVER01'' | Export-Csv ''BackupTest.csv'''
