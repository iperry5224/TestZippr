# SOPRA Assessment Script: SCR-005 - Component Authenticity Verification
# Category: Supply Chain Risk Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SCR_005.ps1
...
$category = "Supply Chain Risk Management"
$control_id = "SCR-005"
$control_name = "Component Authenticity Verification"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Set-ExecutionPolicy AllSigned; Get-AuthenticodeSignature -FilePath ''C:\Software\*.exe'''
