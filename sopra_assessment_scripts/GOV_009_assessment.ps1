# SOPRA Assessment Script: GOV-009 - Interconnection Security Agreements
# Category: Governance & Compliance
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: GOV_009.ps1
...
$category = "Governance & Compliance"
$control_id = "GOV-009"
$control_name = "Interconnection Security Agreements"
