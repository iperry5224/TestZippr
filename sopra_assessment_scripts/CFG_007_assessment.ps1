# SOPRA Assessment Script: CFG-007 - Firmware Security Management
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_007.ps1
...
$category = "Configuration Management"
$control_id = "CFG-007"
$control_name = "Firmware Security Management"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-WmiObject Win32_BIOS | Select-Object Manufacturer, SMBIOSBIOSVersion, ReleaseDate'
