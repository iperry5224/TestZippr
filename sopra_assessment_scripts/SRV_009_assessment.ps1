# SOPRA Assessment Script: SRV-009 - Server Certificate Management
# Category: Server Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: SRV_009.ps1
...
$category = "Server Security"
$control_id = "SRV-009"
$control_name = "Server Certificate Management"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-ChildItem -Path Cert:\LocalMachine\My | Select-Object Subject, NotAfter, Thumbprint'
