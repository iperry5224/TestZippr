# SOPRA Assessment Script: END-007 - Full Disk Encryption
# Category: Endpoint Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: END_007.ps1
...
try {
    $out = Invoke-Expression 'Get-BitLockerVolume | Select-Object MountPoint, EncryptionMethod, VolumeStatus, ProtectionStatus'
