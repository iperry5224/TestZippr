# SOPRA Assessment Script: IR-004 - Evidence Preservation & Chain of Custody
# Category: Incident Response
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: IR_004.ps1
...
$category = "Incident Response"
$control_id = "IR-004"
$control_name = "Evidence Preservation & Chain of Custody"
