# SOPRA Assessment Script: VM-001 - Vulnerability Scanning Program
# Category: Vulnerability Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: VM_001.ps1
...
$category = "Vulnerability Management"
$control_id = "VM-001"
$control_name = "Vulnerability Scanning Program"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Install-Module -Name Nessus -Force; Start-NessusScan -Target ''10.0.0.0/8'' -Policy ''Full Audit'''
