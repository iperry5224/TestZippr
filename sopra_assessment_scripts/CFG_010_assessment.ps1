# SOPRA Assessment Script: CFG-010 - Security Configuration Compliance Reporting
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_010.ps1
...
$category = "Configuration Management"
$control_id = "CFG-010"
$control_name = "Security Configuration Compliance Reporting"
