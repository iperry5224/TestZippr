# SOPRA Assessment Script: END-003 - Host-based Firewall
# Category: Endpoint Security
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: END_003.ps1
...
$category = "Endpoint Security"
$control_id = "END-003"
$control_name = "Host-based Firewall"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-NetFirewallProfile | Select-Object Name, Enabled'
