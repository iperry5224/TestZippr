# SOPRA Assessment Script: CFG-009 - Least Functionality Enforcement
# Category: Configuration Management
# Run on target machine; outputs CSV row for SOPRA import
# Correlates to remediation script: CFG_009.ps1
...
$category = "Configuration Management"
$control_id = "CFG-009"
$control_name = "Least Functionality Enforcement"

# Discovery only - manual review required
try {
    $out = Invoke-Expression 'Get-Service | Where-Object Status -eq ''Running'' | Export-Csv ''RunningServices.csv'''
